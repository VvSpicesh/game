...
const CACHE = "nocturne-games-v115";
...
const PRECACHE = [
  ...
  "./shared/base.css",
  "./shared/base.css?v=0.15.2",
  "./shared/app.js",
  "./shared/app.js?v=0.15.1",
  "./shared/header.js",
  "./shared/fullscreen.js",
  "./shared/settings.js",
  "./shared/game-toast.js",
  "./shared/pwa.js",
  ...
  "./chess/js/game.js?v=stable16",
  "./mahjong/index.html",
  "./mahjong/style.css?v=0.15.24",
  "./mahjong/game.js?v=0.15.24",
  "./mahjong/seat-layout.js?v=0.15.24",
  "./mahjong/render.js?v=0.15.24",
  "./mahjong/meld-view.js?v=0.15.24",
  "./mahjong/player-name.js?v=0.14.49",
  "./mahjong/tiles.js?v=0.14.49",
  "./mahjong/rules-guard.js?v=0.14.24",
  "./mahjong/rule-tests.js?v=0.15.24",
  "./mahjong/tiles-preview.html",
  "./mahjong/storage.js?v=0.14.24",
  "./mahjong/config.js?v=0.14.34",
  "./mahjong/hu.js?v=0.15.8",
  "./mahjong/score.js?v=0.15.8",
  "./mahjong/audio.js?v=0.14.37",
  "./mahjong/win-speech.js?v=0.14.37",
