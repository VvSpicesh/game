...
**日期**：2026-07-20
**Service Worker 缓存**：`nocturne-games-v51`
...
**日期**：2026-07-20
**Service Worker 缓存**：`nocturne-games-v50`

### UI
- 四家弃牌与副露牌面朝向各座位玩家（自己 0° / 对家 180° / 左家 90° / 右家 -90°）
- 来源标签与最新弃牌高亮仍在 wrapper，保持正对当前用户
...
**日期**：2026-07-20
**Service Worker 缓存**：`nocturne-games-v48`

### UI
- 弃牌提示简化：小 Toast + 尺寸回落 + 左右最新靠近自己
...
**日期**：2026-07-20
**Service Worker 缓存**：`nocturne-games-v47`

### UI
- 副露来源：正向竖放 + 外凸 +「上/对/下」标签（取消横牌）
...
**日期**：2026-07-20
**Service Worker 缓存**：`nocturne-games-v46`

### UI
- 弃牌放大 + 最新高亮 + 左右正向 + 中央出牌短提示
